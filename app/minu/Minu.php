...
class Minu
{
    ...
    public function make($argv)
    {
        ...
        switch ($mode) {
            case 'make:controller':
                ...
                $sample_file = file_get_contents('app' . DS . 'minu' . DS . 'samples' . DS . 'controller-sample.php');
            ...
            case 'make:model':
                ...
                $sample_file = file_get_contents('app' . DS . 'minu' . DS . 'samples' . DS . 'model-sample.php');
                $sample_file = preg_replace("/\{CLASSNAME\}/", ucfirst($classname), $sample_file);
            ...
            case 'make:migration':
                ...
                $sample_file = file_get_contents('app' . DS . 'minu' . DS . 'samples' . DS . 'migration-sample.php');
                $sample_file = preg_replace("/\{CLASSNAME\}/", ucfirst($classname), $sample_file);
                $sample_file = preg_replace("/\{classname\}/", strtolower($classname), $sample_file);
    ...
    Minu v$this->version Command Line Tool
